...
export const moduleResearchNotes = {
  ...
  'Matematika LPDP': {
    summary: 'Blueprint numerik dibuat lebih sulit dengan mengacu pada format resmi TBS LPDP yang menilai penalaran kuantitatif dan pemecahan masalah, lalu ditingkatkan ke konteks finansial-public policy multi-langkah.',
    priorities: [
      'Mengacu ke TBS LPDP: penalaran kuantitatif dan pemecahan masalah di bawah tekanan waktu, sehingga soal difokuskan pada hitungan ringkas tetapi konseptual.',
      'Topik yang diperluas ke level sulit: bunga majemuk, present value, annuitas, break-even, persentase bertingkat, expected value, CAGR, work-rate, campuran, optimasi anggaran, dan interpretasi data.',
      'Setiap soal dibedakan lewat konteks, parameter, dan langkah inferensi agar 200 prompt MCQ tetap unik tanpa pengulangan literal.',
    ],
    sources: [
      {
        label: 'detikEdu — Ketentuan resmi TBS LPDP 2024 (penalaran verbal, kuantitatif, pemecahan masalah)',
        url: 'https://www.detik.com/edu/beasiswa/d-7511811/catat-ini-ketentuan-terbaru-seleksi-bakat-skolastik-lpdp-2024-dibagi-2-sesi',
      },
      {
        label: 'LPDP — Kebijakan Umum Beasiswa 2024 (tahapan seleksi administrasi, bakat skolastik, substansi)',
        url: 'https://lpdp.kemenkeu.go.id/storage/beasiswa/kebijakan-umum/file/public_policy_file_1724075967.pdf',
      },
    ],
  },
  'Tes Substansi LPDP': {
    summary: 'Soal substansi difokuskan pada pola wawancara LPDP: integritas, kepemimpinan, komitmen kembali, rencana pascastudi, kontribusi di Indonesia, dan kemampuan menurunkan ide menjadi implementasi terukur.',
    priorities: [
      'Riset resmi LPDP menekankan komitmen kembali ke Indonesia, rencana pascastudi, dan rencana kontribusi; karena itu prompt dibuat case-based, bukan hafalan definisi.',
      'Level sulit ditingkatkan lewat trade-off kebijakan, stakeholder resistance, baseline data lemah, tata kelola program, indikator outcome, serta mitigasi risiko implementasi.',
      'Setiap prompt dibuat unik pada kombinasi isu nasional, sudut penilaian, dan dilema keputusan agar tidak ada dua soal yang berbunyi sama.',
    ],
    sources: [
      {
        label: 'LPDP — Halaman umum beasiswa (dokumen komitmen kembali, rencana pascastudi, kontribusi di Indonesia)',
        url: 'https://lpdp.kemenkeu.go.id/storage/beasiswa/general/page/file/general_page_file_1751535380.pdf',
      },
      {
        label: 'LPDP — Webinar kelulusan substansi 2025 (penekanan integritas, pemimpin, agen perubahan)',
        url: 'https://lpdp.kemenkeu.go.id/informasi/berita/lpdp-sambut-2511-peserta-lolos-seleksi-substansi-tahap-2-tahun-2025/',
      },
      {
        label: 'LPDP — Kebijakan Umum 2024 (tahapan substansi dan prioritas strategis)',
        url: 'https://lpdp.kemenkeu.go.id/storage/beasiswa/kebijakan-umum/file/public_policy_file_1724075967.pdf',
      },
    ],
  },
